...
class App extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      ipfs_log_hash:  "QmdLkWbda3DvRp8rdYw4YeaxDNXPSMsQG46oUejQvtYtdj",//'QmTRG7kJQYDqFUMWoLWVCQHJUbKShQX5FCWVB1X9AzcDQJ',  //hash of the file holding all the files currently saved
...
FetchData(event)
{
  ...
  var returnval = this.simpleStorageInstance.get_value(this.state.FileNameFromUser).then(function(h, o, s) {
    ...
    /*TODO: 
        ...
        While this is not important, the contract should return separate values
...
*/
  ...
  */
  ...
  var fs = require('browserify-fs');
   //console.log(currentDate);
   fs.appendFile('D:\FileNames.txt', "\n" + this.state.SelectedFileName, function() {
    fs.readFile('D:\FileNames.txt', 'utf8', function(err, data) {
        console.log(data);
